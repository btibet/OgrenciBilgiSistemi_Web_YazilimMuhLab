<%@ Page Title="" Language="C#" MasterPageFile="~/Ogretmen.Master" AutoEventWireup="true" CodeBehind="NotGuncelle.aspx.cs" Inherits="WebApplication1.NotGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <form id="form1" runat="server">
        ...
        <asp:Button ID="BtnHesapla" runat="server" Text="Hesapla" CssClass="btn-toolbar" OnClick="BtnHesapla_Click"  />
        <asp:Button ID="BtnGuncelle" runat="server" Text="Güncelle" CssClass="btn-primary" OnClick="BtnGuncelle_Click" />
